...
public final class CardManager {
    ...
    private CardManager() {
        ...
        angryMob.addCantGetChosenBy("Broomstick");//Broomstick can't get chosen by angry mob
        ...
        duckingStool.addCantGetChosenBy("Wart");//Wart can't be chosen by ducking stool
